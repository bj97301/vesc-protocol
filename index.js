...
(function (module) {
  (function (root, definition) {
    ...
    let isIE = (typeof window !== undefinedType) && (typeof window.navigator !== undefinedType) && (
    ...
    let enableLoggingWhenConsoleArrives = (methodName, level, loggerName) => function () {
      if (typeof console !== undefinedType) {
    ...
    function Logger(name, defaultLevel, factory) {
      ...
      function persistLevelIfPossible(levelNum) {
        let levelName = (logMethods[levelNum] || 'silent').toUpperCase()
...
/** PURE_IMPORTS_START  PURE_IMPORTS_END */
let isArray = /* @__PURE__ */ (() => Array.isArray || ((x) => x && typeof x.length === 'number'))()

/** PURE_IMPORTS_START  PURE_IMPORTS_END */
const isObject = (x) => x !== null && typeof x === 'object'

/** PURE_IMPORTS_START  PURE_IMPORTS_END */
let UnsubscriptionErrorImpl = /* @__PURE__ */ (function () {
...
let UnsubscriptionError = UnsubscriptionErrorImpl

/** PURE_IMPORTS_START _util_isArray,_util_isObject,_util_isFunction,_util_UnsubscriptionError PURE_IMPORTS_END */
let Subscription = /* @__PURE__ */ (function () {
  ...
  Subscription.prototype.unsubscribe = function () {
    ...
    let _a = this; let _parentOrParents = _a._parentOrParents; let _ctorUnsubscribe = _a._ctorUnsubscribe; let _unsubscribe = _a._unsubscribe; let _subscriptions = _a._subscriptions
    this.closed = true
    this._parentOrParents = null
    this._subscriptions = null
    if (_parentOrParents instanceof Subscription) {
      ...
      for (var index = 0; index < _parentOrParents.length; ++index) {
        let parent_1 = _parentOrParents[index]
  ...
  Subscription.prototype.add = function (teardown) {
    ...
    let _parentOrParents = subscription._parentOrParents
  ...
  Subscription.prototype.remove = function (subscription) {
    let subscriptions = this._subscriptions
    if (subscriptions) {
      let subscriptionIndex = subscriptions.indexOf(subscription)
...
const flattenUnsubscriptionErrors = (errors) => errors.reduce((errs, err) => errs.concat((err instanceof UnsubscriptionError) ? err.errors : err), [])

/** PURE_IMPORTS_START  PURE_IMPORTS_END */
let rxSubscriber = /* @__PURE__ */ (() => typeof Symbol === 'function'
  ? /* @__PURE__ */ Symbol('rxSubscriber')
  : '@@rxSubscriber_' + /* @__PURE__ */ Math.random())()

/** PURE_IMPORTS_START tslib,_util_isFunction,_Observer,_Subscription,_internal_symbol_rxSubscriber,_config,_util_hostReportError PURE_IMPORTS_END */
let Subscriber = /* @__PURE__ */ (function (_super) {
  ...
  Subscriber.create = function (next, error, complete) {
    let subscriber = new Subscriber(next, error, complete)
  ...
  Subscriber.prototype._unsubscribeAndRecycle = function () {
    let _parentOrParents = this._parentOrParents
    this._parentOrParents = null
    this.unsubscribe()
    this.closed = false
...
var SafeSubscriber = /* @__PURE__ */ (function (_super) {
  ...
  SafeSubscriber.prototype.next = function (value) {
    if (!this.isStopped && this._next) {
      let _parentSubscriber = this._parentSubscriber
  ...
  SafeSubscriber.prototype.error = function (err) {
    if (!this.isStopped) {
      let _parentSubscriber = this._parentSubscriber
      let useDeprecatedSynchronousErrorHandling = config.useDeprecatedSynchronousErrorHandling
      if (this._error) {
  ...
  SafeSubscriber.prototype.complete = function () {
    ...
    if (!this.isStopped) {
      let _parentSubscriber = this._parentSubscriber
      if (this._complete) {
        let wrappedComplete = () => _this._complete.call(_this._context)
        if (!config.useDeprecatedSynchronousErrorHandling || !_parentSubscriber.syncErrorThrowable) {
...
function canReportError(observer) {
  while (observer) {
    let _a = observer; let closed_1 = _a.closed; let destination = _a.destination; let isStopped = _a.isStopped
...
/** PURE_IMPORTS_START  PURE_IMPORTS_END */
let observable = /* @__PURE__ */ (() => typeof Symbol === 'function' && Symbol.observable || '@@observable')()
...
let Observable = /* @__PURE__ */ (function () {
  ...
  Observable.prototype.subscribe = function (observerOrNext, error, complete) {
    ...
    let sink = toSubscriber(observerOrNext, error, complete)
    if (operator) {
...
/** PURE_IMPORTS_START  PURE_IMPORTS_END */
let ObjectUnsubscribedErrorImpl = /* @__PURE__ */ (function () {
...
let ObjectUnsubscribedError = ObjectUnsubscribedErrorImpl

/** PURE_IMPORTS_START tslib,_Subscription PURE_IMPORTS_END */
let SubjectSubscription = /* @__PURE__ */ (function (_super) {
...
let SubjectSubscriber = /* @__PURE__ */ (function (_super) {
  __extends(SubjectSubscriber, _super)
  function SubjectSubscriber(destination) {
    let _this = _super.call(this, destination) || this
    _this.destination = destination
    return _this
  }
  return SubjectSubscriber
}(Subscriber))
let Subject = /* @__PURE__ */ (function (_super) {
  ...
  Subject.prototype.lift = function (operator) {
    let subject = new AnonymousSubject(this, this)
