...
describe('The parser', () => {
  it('should return an array', () => {
    let payload = Buffer.from('020100000003')
    expect(bufferToArray(payload)).toStrictEqual([
      '30',
      '32',
      '30',
      '31',
  ...
  it('should return the Firmware version', () => {
    let payload = MESSAGE_FW_VERSION.PACKAGE
    ...
    return getFWVersion(buffer).then(data => {
      ...
      expect(data.uuid).toStrictEqual([
        '3c',
        '00',
        '37',
        '00',
  ...
  it('should return the values', () => {
    let payload = MESSAGE_GET_VALUES.PACKAGE
    let buffer = new VescBuffer(payload)
  ...
  it('should return the decoded PPM', () => {
    let payload = MESSAGE_GET_DECODED_PPM.PACKAGE
    let buffer = new VescBuffer(payload)
  ...
  it('should return the decoded ADC', () => {
    let payload = MESSAGE_GET_DECODED_ADC.PACKAGE
    let buffer = new VescBuffer(payload)
  ...
  it('should return the status 1', () => {
    let payload = MESSAGE_STATUS_1.PACKAGE
    let buffer = new VescBuffer(payload)
  ...
  it('should return the status 2', () => {
    let payload = MESSAGE_STATUS_2.PACKAGE
    let buffer = new VescBuffer(payload)
  ...
  it('should return the status 3', () => {
    let payload = MESSAGE_STATUS_3.PACKAGE
    let buffer = new VescBuffer(payload)
  ...
  it('should return the status 4', () => {
    let payload = MESSAGE_STATUS_4.PACKAGE
    let buffer = new VescBuffer(payload)
  ...
  it('should return the status 5', () => {
    let payload = MESSAGE_STATUS_5.PACKAGE
    let buffer = new VescBuffer(payload)
  ...
  it('should return the valueSetupSelective command', () => {
    let payload = MESSAGE_GET_VALUES_SETUP_SELECTIVE.PACKAGE
    let buffer = new VescBuffer(payload)
  ...
  it('should return the valueSetupSelective command only with temp', () => {
    let payload = MESSAGE_GET_VALUES_SETUP_SELECTIVE.PACKAGE_TEMP_ONLY
    let buffer = new VescBuffer(payload)
    return getValuesSetupSelective(buffer).then(data => {
      expect(data.temp.mosfet).toBe(42.3)
      expect(data.temp.motor).toBe(31.2)
  ...
  it('should return the balancedata command', () => {
    let payload = MESSAGE_COMM_GET_IMU_DATA.PACKAGE
    let buffer = new VescBuffer(payload)
  ...
  it('should return the BMS values', () => {
    let payload = MESSAGE_COMM_BMS_GET_VALUES.PACKAGE
    let buffer = new VescBuffer(payload)
  ...
  it('should return the app configuration', () => {
    let payload = MESSAGE_COMM_GET_APPCONF.PACKAGE
    let buffer = new VescBuffer(payload)
